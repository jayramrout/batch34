 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://helloworld.ws.tutorial.com/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://helloworld.ws.tutorial.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://helloworld.ws.tutorial.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloworld.ws.tutorial.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
