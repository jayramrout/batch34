 ...
 * generated in the com.tutorial.ws.order package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessOrderResponse_QNAME = new QName("http://order.ws.tutorial.com/", "processOrderResponse");
    private final static QName _ProcessOrder_QNAME = new QName("http://order.ws.tutorial.com/", "processOrder");
    private final static QName _Order_QNAME = new QName("http://order.ws.tutorial.com/", "Order");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.tutorial.ws.order
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://order.ws.tutorial.com/", name = "processOrderResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://order.ws.tutorial.com/", name = "processOrder")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://order.ws.tutorial.com/", name = "Order")
